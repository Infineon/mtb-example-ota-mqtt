...
*
* Description: This file contains the mbedtls configuration macros.
*
 ...
 */
#if !(defined(CYW20829) || defined(CYW89829) || defined(PSOC_062_1M) || defined(PSOC_063_1M))
/*
 * Enabling this define for some BT platforms causes the link to fail when using the ARM compiler.
 * The ARM compiler seems to perform garbage collection after resolving all symbols. This
 * causes the link to fail even though unresolved symbol is not present in the final
 * application image.
 */
